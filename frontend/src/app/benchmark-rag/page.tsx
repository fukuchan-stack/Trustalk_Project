...
export default function BenchmarkRagPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setResults(data);
      if (data.length > 0) {
        setActiveDetailModel(data[0].model_name);
      }
    } catch (err: any) {
      ...
      <div className="w-full max-w-6xl">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200 mb-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">1. 質問・回答CSVファイルを選択</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">3. 評価するAIモデルを選択</label>
